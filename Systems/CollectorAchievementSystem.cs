...
namespace CollectorAchievements.Systems
{
    public class CollectorAchievementSystem : AchievementSystem
    {
        ...
        private static readonly Dictionary<string, int[]> ArmorPieces = new()
        {
            ...
            { "Miscellaneous", [ItemID.EmptyBucket, ItemID.Goggles, ItemID.DivingHelmet, ItemID.NightVisionHelmet, ItemID.VikingHelmet, ItemID.UltrabrightHelmet, ItemID.FlinxFurCoat, ItemID.Gi, ItemID.MoonLordLegs, ItemID.GreenCap]}
        };
        ...
        private readonly Dictionary<string, int[]> Banners = new()
        {
        ...
        private readonly int[] Mounts = [ItemID.SlimySaddle, ItemID.HoneyedGoggles, ItemID.HardySaddle, ItemID.FuzzyCarrot, ItemID.PogoStick, ItemID.GolfCart, ItemID.MolluskWhistle, ItemID.PaintedHorseSaddle, ItemID.MajesticHorseSaddle, ItemID.DarkHorseSaddle, ItemID.SuperheatedBlood, ItemID.AncientHorn, ItemID.BlessedApple, ItemID.ScalyTruffle, ItemID.QueenSlimeMountSaddle, ItemID.ReindeerBells, ItemID.BrainScrambler, ItemID.CosmicCarKey, ItemID.DrillContainmentUnit];

        private readonly Dictionary<string, int[]> PaintingsBuy = new()
        {
            { "PAINTINGS_BUY_CLOTHIER", [ItemID.PlacePainting] },
            { "PAINTINGS_BUY_GOLFER", [ItemID.GolfPainting1, ItemID.GolfPainting2, ItemID.GolfPainting3, ItemID.GolfPainting4] },
            { "PAINTINGS_BUY_PAINTER", [ItemID.ColdWatersintheWhiteLand, ItemID.Daylight, ItemID.DeadlandComesAlive, ItemID.DoNotStepontheGrass, ItemID.EvilPresence, ItemID.FirstEncounter, ItemID.GoodMorning, ItemID.TheLandofDeceivingLooks, ItemID.LightlessChasms, ItemID.PlaceAbovetheClouds, ItemID.SecretoftheSands, ItemID.SkyGuardian, ItemID.ThroughtheWindow, ItemID.UndergroundReward, ItemID.Purity, ItemID.Thunderbolt] },
            { "PAINTINGS_BUY_PAINTER_GRAVEYARD", [ItemID.Nevermore, ItemID.Reborn, ItemID.Graveyard, ItemID.GhostManifestation, ItemID.WickedUndead, ItemID.HailtotheKing, ItemID.BloodyGoblet, ItemID.StillLife] },
            { "PAINTINGS_BUY_PRINCESS", [ItemID.Princess64, ItemID.PaintingOfALass, ItemID.DarkSideHallow, ItemID.PrincessStyle, ItemID.SuspiciouslySparkly, ItemID.TerraBladeChronicles, ItemID.RoyalRomance] },
            { "PAINTINGS_BUY_TRAVELING_MERCHANT", [ItemID.PaintingAcorns, ItemID.PaintingCastleMarsberg, ItemID.PaintingColdSnap, ItemID.PaintingCursedSaint, ItemID.PaintingMartiaLisa, ItemID.MoonLordPainting, ItemID.PaintingWendy, ItemID.PaintingWillow, ItemID.PaintingWilson, ItemID.PaintingWolfgang, ItemID.PaintingTheSeason, ItemID.PaintingSnowfellas, ItemID.PaintingTheTruthIsUpThere, ItemID.HoplitePizza, ItemID.YuumaTheBlueTiger, ItemID.MoonmanandCompany, ItemID.SunshineofIsrapony, ItemID.BennyWarhol, ItemID.DoNotEattheVileMushroom, ItemID.Duality, ItemID.KargohsSummon, ItemID.ParsecPals] },
            { "PAINTINGS_BUY_TRUFFLE", [ItemID.MySon] },
            { "PAINTINGS_BUY_ZOOLOGIST", [ItemID.TheWerewolf] }
        };

        private readonly Dictionary<string, int[]> PaintingsBreak = new()
        {
            { "PAINTINGS_BREAK_DUNGEON", [ItemID.BloodMoonRising, ItemID.BoneWarp, ItemID.TheCreationoftheGuide, ItemID.TheCursedMan, ItemID.TheDestroyer, ItemID.Dryadisque, ItemID.TheEyeSeestheEnd, ItemID.FacingtheCerebralMastermind, ItemID.GloryoftheFire, ItemID.GoblinsPlayingPoker, ItemID.GreatWave, ItemID.TheGuardiansGaze, ItemID.TheHangedMan, ItemID.Impact, ItemID.ThePersistencyofEyes, ItemID.PoweredbyBirds, ItemID.TheScreamer, ItemID.SkellingtonJSkellingsworth, ItemID.SparkyPainting, ItemID.SomethingEvilisWatchingYou, ItemID.StarryNight, ItemID.TrioSuperHeroes, ItemID.TheTwinsHaveAwoken, ItemID.UnicornCrossingtheHallows] },
            { "PAINTINGS_BREAK_JUNGLE_TEMPLE", [ItemID.LizardKing] },
            { "PAINTINGS_BREAK_UNDERGROUND_CABINS", [ItemID.AmericanExplosive, ItemID.AuroraBorealis, ItemID.Bifrost, ItemID.Bioluminescence, ItemID.CatSword, ItemID.CrownoDevoursHisLunch, ItemID.Discover, ItemID.FairyGuides, ItemID.FatherofSomeone, ItemID.FindingGold, ItemID.ForestTroll, ItemID.GloriousNight, ItemID.GuidePicasso, ItemID.HappyLittleTree, ItemID.Heartlands, ItemID.AHorribleNightforAlchemy, ItemID.Land, ItemID.TheMerchant, ItemID.MorningHunt, ItemID.NurseLisa, ItemID.OldMiner, ItemID.Outcast, ItemID.RareEnchantment, ItemID.Secrets, ItemID.StrangeDeadFellows, ItemID.StrangeGrowth, ItemID.SufficientlyAdvanced, ItemID.Sunflowers, ItemID.TerrarianGothic, ItemID.VikingVoyage, ItemID.Waldo, ItemID.Wildflowers] },
            { "PAINTINGS_BREAK_UNDERGROUND_CABINS_DESERT", [ItemID.AndrewSphinx, ItemID.WatchfulAntlion, ItemID.BurningSpirit, ItemID.JawsOfDeath, ItemID.TheSandsOfSlime, ItemID.SnakesIHateSnakes, ItemID.LifeAboveTheSand, ItemID.Oasis, ItemID.PrehistoryPreserved, ItemID.AncientTablet, ItemID.Uluru, ItemID.VisitingThePyramids, ItemID.BandageBoy, ItemID.DivineEye] },
            { "PAINTINGS_BREAK_UNDERWORLD", [ItemID.DarkSoulReaper, ItemID.Darkness, ItemID.DemonsEye, ItemID.FlowingMagma, ItemID.HandEarth, ItemID.ImpFace, ItemID.LakeofFire, ItemID.LivingGore, ItemID.OminousPresence, ItemID.ShiningMoon, ItemID.Skelehead, ItemID.TrappedGhost] }
        };

        private readonly Dictionary<string, int[]> PaintingsGrab = new()
        {
            { "PAINTINGS_GRAB_DUNGEON_CHEST", [ItemID.RemnantsofDevotion] },
            { "PAINTINGS_GRAB_FLOATING_ISLAND", [ItemID.HighPitch, ItemID.Constellation, ItemID.LoveisintheTrashSlot, ItemID.SunOrnament, ItemID.BlessingfromTheHeavens, ItemID.SeeTheWorldForWhatItIs] }
        };

        private readonly Dictionary<string, int[]> PaintingsCatch = new()
        {
            { "PAINTING_CATCH_BLOOD_MOON", [ItemID.DreadoftheRedSea] },
            { "PAINTING_CATCH_HALLOW", [ItemID.LadyOfTheLake] }
        };
        private readonly int[] PaintingsAnglerRewards = [ItemID.PillaginMePixels, ItemID.CouchGag, ItemID.Crustography, ItemID.Fangs, ItemID.NotSoLostInParadise, ItemID.SilentFish, ItemID.TheDuke, ItemID.WhatLurksBelow];
        private readonly int[] PaintingsGoodieBags = [ItemID.BitterHarvest, ItemID.BloodMoonCountess, ItemID.HallowsEve, ItemID.JackingSkeletron, ItemID.MorbidCuriosity];
        private readonly int[] PaintingsSolarEclipse = [ItemID.Requiem, ItemID.OcularResonance, ItemID.AMachineforTerrarians, ItemID.WingsofEvil, ItemID.ThisIsGettingOutOfHand, ItemID.Eyezorhead, ItemID.MidnightSun, ItemID.Buddies];

        private readonly Dictionary<string, int[]> Pets = new()
        {
        ...
        private readonly Dictionary<string, int[]> FishCatch = new()
        {
        ...
        protected override void RegisterAchievements()
        {
            ...
            foreach (var group in PaintingsBreak)
                RegisterAchievement(group.Key, TileDropCondition.DropAll(reqs, group.Value), group.Value.Length > 1, AchievementCategory.Collector);

            foreach (var group in PaintingsGrab)
            ...
            foreach (var group in PaintingsCatch)
            ...
            RegisterAchievement("PAINTING_ANGLER_REWARD", ItemGiftCondition.GiftAll(reqs, NPCID.Angler, PaintingsAnglerRewards), true, AchievementCategory.Collector);
            RegisterAchievement("PAINTING_GOODIE_BAG", ItemOpenCondition.OpenAll(reqs, ItemID.GoodieBag, PaintingsGoodieBags), true, AchievementCategory.Collector);
            RegisterAchievement("PAINTING_SOLAR_ECLIPSE", NpcDropCondition.DropAll(reqs, NPCID.None, PaintingsSolarEclipse), true, AchievementCategory.Collector);
